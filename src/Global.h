...
typedef std::vector<edge_info_t> edge_vector_t;
...
public:
  ...
  static char Model_file[FRED_STRING_SIZE];
  ...
  static std::chrono::high_resolution_clock::time_point Simulation_start_time;
  ...
  static bool Enable_List_Var_Records;
  ...
  static bool Enable_External_Variable_Initialization;
  ...
  static spdlog::sink_ptr StdoutSink;
  static spdlog::sink_ptr ErrorFileSink;
  static spdlog::sink_ptr TraceFileSink;
  static spdlog::sink_ptr DebugFileSink;
