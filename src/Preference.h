...
/**
 * This class represents a preference in the FRED language.
 */
class Preference {
 ...
 public:
  Preference();
  ~Preference();
  void add_preference_expressions(std::string expr_str);
 ...
 private:
  ...
  static std::string preference_log_level;
  static std::unique_ptr<spdlog::logger> preference_logger;
};
