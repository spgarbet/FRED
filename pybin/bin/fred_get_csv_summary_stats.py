...
def fred_get_csv_summary_stats(fred_key: str, frequency_dir: Literal['DAILY', 'WEEKLY'], selected_index: int, filename: str) -> Literal[0, 2]:
    '''
